...
plot(0,0,type='n',xlim=c(-1100,0),ylim=c(0,maxy),axes=FALSE,frame.plot=FALSE, xlab="Time (MYA)", ylab="", cex.lab=1.3)
...
text(meta_body+10, 0.89*maxy, "Earliest animal fossils", pos=4)
...
text(-475, 0.74*maxy, "Fungi", col="#389192", cex=textsize)
rect(asco_lca[1],  0.64*maxy, asco_lca[2],  0.67*maxy, col="#389192dd", border=FALSE)
text(asco_lca[2], 0.655*maxy, "Chang 2015 MC", pos=4)
...
points(-400, 0.70*maxy, cex=2, pch=17, col="#389192")
text(-390, 0.70*maxy, "Earliest Ascomycota fossils", pos=4)
points(-330, 0.58*maxy, cex=2, pch=17, col="#4075b2")
text(-320, 0.58*maxy, "Earliest Basidiomycota fossils", pos=4)


# 0.49 as max
text(-850, 0.48*maxy, "Rhodophytes", col="#bc3c0a", cex=textsize)
...
text(rhodo_body[1]-10, 0.43*maxy, "Earliest Florideophyceae fossils", pos=2)
points(rhodo_lca_mids, c(0.315,0.355,0.395)*maxy, pch=5, col="#bc3c0a")

text(-440, 0.32*maxy, "Embryophytes", col="#18d025", cex=textsize)
...
text(-400, 0.27*maxy, "Earliest plant fossils", pos=4)

text(-110, 0.13*maxy, "Laminarialeans", col="#8d8f0d", cex=textsize)
rect(phaeo_lca_silber[1],  0.01*maxy, phaeo_lca_silber[2],  0.04*maxy, col="#8d8f0d99", border=FALSE)
text(phaeo_lca_silber[1], 0.025*maxy, "Silberfeld 2010 MC", pos=2)
points(phaeo_body, 0.07*maxy, cex=2, pch=17, col="#8d8f0d")
text(phaeo_body-10, 0.07*maxy, "Earliest laminariales fossils", pos=2)
